...
public class LocationOp implements Aggregator<Map<String, DATA>> {
	private static final long serialVersionUID = 8885042533417688302L;
	...
	public void aggregate(Map<String, DATA> map,TridentTuple tuple, TridentCollector collector) {
		...
		String key=src_province+","+Op+Common.GetSymbol()+time;
