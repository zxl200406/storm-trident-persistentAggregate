...
public class LocationOpIp implements Aggregator<Map<String, DATA>> {
	private static final long serialVersionUID = -9211804453773570598L;
	...
	public void aggregate(Map<String, DATA> map,TridentTuple tuple, TridentCollector collector) {
		...
		//地区+运营商+Ip
		String key=src_province+","+Op+","+Ip+Common.GetSymbol()+time;
